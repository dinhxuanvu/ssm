...
class BtrfsFunctionCheck(MockSystemDataSource):
    ...
    def test_btrfs_remove(self):
        ...
        # remove volume
        self._checkCmdIgnoreOrder("ssm remove default_pool", "wipefs -a -t btrfs", "/dev/sdb /dev/sda")
        self._checkCmdIgnoreOrder("ssm remove my_pool", "wipefs -a -t btrfs", "/dev/sdc2 /dev/sdc1 /dev/sdc3")
        ...
        self._checkCmd("ssm remove /dev/sdd /dev/sdb other_pool my_pool default_pool:/dev/default_pool/vol001", [],
            "btrfs subvolume delete /mnt/test")
        self._checkCmdIgnoreOrder(None, "wipefs -a -t btrfs", "/dev/sdc2 /dev/sdc3 /dev/sdc1", -2)

        self._checkCmdIgnoreOrder(None, "wipefs -a -t btrfs", "/dev/sdd /dev/sde", -4)
        ...
        # remove all
        self._checkCmdIgnoreOrder("ssm remove --all", "wipefs -a -t btrfs", "/dev/sdd /dev/sde")
        self._checkCmdIgnoreOrder(None, "wipefs -a -t btrfs", "/dev/sdc2 /dev/sdc3 /dev/sdc1", -3)
        self._checkCmdIgnoreOrder(None, "wipefs -a -t btrfs", "/dev/sdb /dev/sda", -5)
